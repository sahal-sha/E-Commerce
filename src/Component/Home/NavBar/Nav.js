            ...
            {['md'].map((expand) => (
                <Navbar key={expand} expand={expand} className="Navbar mb-3" style={{ zIndex: '2', marginTop: "-10px", marginBottom: "0px", alignContent: "center" }}>
                    <Container fluid>
                        <Navbar.Brand href="/">
                            <Link to={'/'}>
                                <img className="Logo" src={require('./Logo/Wooden_Street-Logo.wine.png')} alt="logo" />
                        ...
                        >
                            <Offcanvas.Header closeButton>
                                <Offcanvas.Title id={`offcanvasNavbarLabel-expand-${expand}`}>
                                    <img className="log" src={require('./Logo/wooden-streetlogo2x.jpeg')} alt="ll" />
                                </Offcanvas.Title>
                            </Offcanvas.Header>
                            <Offcanvas.Body>
                                <Nav className="justify-content-end flex-grow-1 pe-3">
                                    ...
                                    <Nav.Link ><Link className="NavPages">
                                        <DropdownButton id="dropdown-basic-button" title={<FaRegCircleUser style={{ fontSize: '24px' }} />} className="noborderbutton">
                                            ...
                                            {
                                                ifLogin ? <Dropdown.Item style={{ backgroundColor: "inherit" }}><Link className="NavPages" to={'/'} onClick={Logout} ><h5>LOGOUT</h5></Link></Dropdown.Item> : <Dropdown.Item style={{ backgroundColor: 'inherit' }}><Link className='NavPages' to={'/Login'}><h5>LOGIN</h5></Link></Dropdown.Item>
                                            }
                                        </DropdownButton>
                                    </Link>
                                    </Nav.Link> 
