...
const Register = ({ validateUser }) => {
  ...
  return (
    <>
      <div style={{ backgroundColor: "silver"}} className="register-div">
        <form onSubmit={(e) => e.preventDefault} style={{ maxWidth: "600px" }} className="container-fluid rg-inp-div">
          <h3 style={{ color: "black" }}>REGISTER</h3><br />
          <div>
            <div>
              <input
                type="text"
            ...
            <span className="bold">Already have an account? <Link to={'/Login'}>Click Here</Link> </span>
            <br /><br />
